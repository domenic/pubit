...
describe "Publish with `publish.when` with option.async", ->
    publisher = null
    emitter = null
    listener55 = null
    listener66 = null
    ...
    beforeEach ->
        ...
        publisher = new Publisher({events: ["eventName"], async: true})
    ...
    describe "having a single listener return `55`", ->
        it "should return a promise that resolves to `[55]`", (next) ->
            ...
            listener55.should.not.have.been.called
    ...
    describe "having a two listeners returning `55` and `66` respectively", ->
        it "should return a promise that resolves to `[55, 66]`", (next) ->
            ...
            listener55.should.not.have.been.called
            listener66.should.not.have.been.called
